...
//    @IBOutlet weak var exposureModeSegmentControl: UISegmentedControl!
...
//    @IBOutlet weak var exposureTargetBiasLabel: UILabel!
//    @IBOutlet weak var exposureTargetBiasValue: UILabel!
//    @IBOutlet weak var exposureTargetBiasSlider: UISlider!
//
//    @IBOutlet weak var exposureTargetOffsetLabel: UILabel!
...
//    @IBOutlet weak var tintValue: UILabel!
 //   @IBOutlet weak var tintSlider: UISlider!
   ...
   func reset() {
//        cameracontrols.zoomFactorObserve()
//        cameracontrols.colorTemperatureObserve()
//        cameracontrols.exposureDurationObserve()
//        cameracontrols.isoObserve()
//        cameracontrols.torchSliderObserve()
//        cameracontrols.whiteBalanceGainsObserve()
//        cameracontrols.zoomFactorObserve()
...
//                captureDevice?.videoZoomFactor = CGFloat(2.0)
...
//            cameraViewController.finalZoomLevel = CGFloat(zoomTo)
//            torchTo = 0.3
//            exposureDurationSlider.value = 0.15
//            isoSlider.value = 300
//            colorTemperatureSlider.value = 5500
//            }
...
//    private var ExposureTargetOffsetContext = 0
    ...
    @IBAction func exposureDurationValueChanged(_ control: UISlider) {
        ...
        print("newDurationSeconds = ", newDurationSeconds)
      }
...
//            tintSlider.value = 0
//            let whiteBalanceGains = self.backCamera?.deviceWhiteBalanceGains ?? AVCaptureDevice.WhiteBalanceGains()
 //           let whiteBalanceTemperatureAndTint = self.backCamera?.temperatureAndTintValues(for: whiteBalanceGains) ?? AVCaptureDevice.WhiteBalanceTemperatureAndTintValues()

            self.colorTemperatureSlider.minimumValue = 2000
            self.colorTemperatureSlider.maximumValue = 9000
//            self.colorTemperatureSlider.value = whiteBalanceTemperatureAndTint.temperature
//            print("white balance gains = ", whiteBalanceGains)
        }
